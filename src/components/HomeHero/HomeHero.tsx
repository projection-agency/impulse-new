      ...
      <Layout>
        <div className={s.heroBottomContainer}>
          <div className={s.swiperController}>
            <div className={s.tab}>
              <div className={s.tabImageBorder}>
                <img src="/temp/carCircle.png" alt="" />
              </div>
              <div className={s.tabInfo}>
                <h4>Lamborghini 2.0</h4>
                <p>Munich, Dolomites, Bologna</p>
                <p>
                  <svg
                    viewBox="0 0 16 17"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g opacity="0.6" clip-path="url(#clip0_1540_214)">
                      <path d="M5.33333 8.5H4C3.26467 8.5 2.66667 9.098 2.66667 9.83333V11.1667C2.66667 11.902 3.26467 12.5 4 12.5H5.33333C6.06867 12.5 6.66667 11.902 6.66667 11.1667V9.83333C6.66667 9.098 6.06867 8.5 5.33333 8.5ZM4 11.1667V9.83333H5.33333V11.1667H4ZM12.6667 1.83333H12V1.16667C12 0.798667 11.702 0.5 11.3333 0.5C10.9647 0.5 10.6667 0.798667 10.6667 1.16667V1.83333H5.33333V1.16667C5.33333 0.798667 5.03533 0.5 4.66667 0.5C4.298 0.5 4 0.798667 4 1.16667V1.83333H3.33333C1.49533 1.83333 0 3.32867 0 5.16667V13.1667C0 15.0047 1.49533 16.5 3.33333 16.5H12.6667C14.5047 16.5 16 15.0047 16 13.1667V5.16667C16 3.32867 14.5047 1.83333 12.6667 1.83333ZM3.33333 3.16667H12.6667C13.7693 3.16667 14.6667 4.064 14.6667 5.16667V5.83333H1.33333V5.16667C1.33333 4.064 2.23067 3.16667 3.33333 3.16667ZM12.6667 15.1667H3.33333C2.23067 15.1667 1.33333 14.2693 1.33333 13.1667V7.16667H14.6667V13.1667C14.6667 14.2693 13.7693 15.1667 12.6667 15.1667Z" />
                    </g>
                    <defs>
                      <clipPath id="clip0_1540_214">
                        <rect
                          width="16"
                          height="16"
                          fill="white"
